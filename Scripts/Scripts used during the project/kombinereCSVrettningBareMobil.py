...
kobinertCSV = "kobinertTestMobil.csv"
...
def matchGps(time):
    ...
    with open(GPSLoggerCSV, 'r') as gpsData_csv:
        ...
        for l in gpsData:
            ...
            if (timeDif < datetime.timedelta(seconds=2)):
...
with open(gmonproCSV, 'r') as gmonData_csv:
    ...
    for l in gmonData:
        ...
        direction = 'North'
        if gmonTime <= datetime.datetime(2023, 3, 17, 17, 25, 53):
            direction = 'North'
        elif gmonTime <= datetime.datetime(2023, 3, 17, 17, 47, 43):
            direction = 'South'
        elif gmonTime <= datetime.datetime(2023, 3, 17, 18, 3, 10):
            direction = 'North'
        elif gmonTime <= datetime.datetime(2023, 3, 17, 18, 25, 4):
            direction = 'South'
        elif gmonTime <= datetime.datetime(2023, 3, 17, 18, 42, 14):
            direction = 'North'
        else:
            direction = 'South'
